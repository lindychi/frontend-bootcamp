  ...
  return (
    <div className="calendar_s-container ">
      ...
      <div className="text-center justify-items-center">
        <div className="month_s justify-center h-[47px] py-[10px] px-[16px] font-medium  text-center">
          {getMonthString(selectedMonth)}
        </div>
        {/* 미니 캘린더-요일 */}
        <div className="day-s flex items-center h-[33px] p-[10px]">
        ...
        {/* 미니캘린더-날짜     */}
        <div className="calendar_s grid grid-cols-7  h-[218px] p-[10px]">
            ...
            <div
              ...
              className={clsx(
...

                {
                  ...
                  "text-white bg-blue-500 rounded-2xl w-7 h-7 items-center justify-center":
